...
const DeliveryNotification: React.FC<NotificationProps> = ({
  ...
  return (
    <div className={`mb-4 p-4 border rounded-lg shadow-sm transition-all ${read ? 'bg-white border-gray-200' : 'bg-blue-50 border-blue-200'}`}>
      <div className="flex items-start">
        {getIcon()}
        
        <div className="ml-3 flex-1">
          <div className="flex justify-between items-start">
            <h3 className={`text-sm font-medium ${read ? 'text-gray-900' : 'text-blue-900'}`}>{title}</h3>
