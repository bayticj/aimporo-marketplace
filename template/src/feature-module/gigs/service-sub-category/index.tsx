              ...
              <div className="col-md-12">
                ...
                <div className="filters-section">
                  <ul className="filters-wrap">
                            ...
                            <ul className="checkbox-list">
                              ...
                              {showMoreCategories && (
                                ...
                                <div className="view-all">
                                  <Link onClick={toggleMoreCategories}
                                    to="#"
                                    className="viewall-button-one"
                                  >
                                   <span>{showMoreCategories ? 'Less Categories' : 'More 20+ Categories'}</span>
                                  </Link>
                                </div>
                          ...
                          <>
                            ...
                            <ul className="checkbox-list">
                              ...
                              {showMoreLocation && (
                                ...
                                <div className="view-all">
                                  <Link
                                    to="#" onClick={toggleMoreLocation}
                                    className="viewall-btn-location"
                                  >
                                    <span>{showMoreLocation ? 'Less Location' : 'More 20+ Location'}</span>
                                  </Link>
                                </div>
                              </li>
                            </ul>
                    ...
                    {showSellerDetails && (
        <li>
          <div className={`collapse-card ${activeSections.sellerDetails ? 'active' : ''}`}>
            <div className="filter-header">
              <Link to="#" onClick={() => toggleSection('sellerDetails')}>
                <ImageWithBasePath src="assets/img/icons/user-icon.svg" alt="icon" />
                Seller Details
              </Link>
            </div>
            <div id="seller" className={`collapse-body ${activeSections.sellerDetails ? 'active' : 'hidden'}`} style={{ display: activeSections.sellerDetails ? 'block' : 'none' }}>
      ...
      {/* /Seller Details */}
                    ...
                    <li >
                      <div className={`collapse-card ${
                        ...
                        <div className="filter-header">
                          <Link to="#" onClick={() => toggleSection('deliveryTime')}>
                            <ImageWithBasePath
                        ...
                        <div id="deivery" className={`collapse-body ${activeSections.deliveryTime ? 'active' : 'hidden'}`}style={{
                            display: activeSections.deliveryTime ? "block" : "none",
                          }}>
                          <ul className="checkbox-list">
                            <li>
                              <label className="custom_radio">
                    ...
                    <li className="view-all">
                      <Link to="#" className="show-more" onClick={handleShowMore}>
                        ...
                        <span>  {showSellerDetails ? 'Show Less' : 'Show More'}</span>
                      </Link>
                    </li>
                  </ul>
                  {/* /Filter */}
